...
interface BaseScreenProps {
  ...
  /**
   * When this value changes in scroll/auto presets, screen scroll resets to top.
   */
  scrollToTopOnChangeKey?: string | number
  /**
   * Tabletlerde içerik genişliğini merkezleyip sınırlar.
   * Varsayılan olarak açık.
   */
  enableTabletContentConstraint?: boolean
  /**
   * Tablet içerik genişliği için opsiyonel üst limit.
   */
...
export function Screen(props: ScreenProps) {
  ...
  const resolvedTabletContentMaxWidth =
    enableTabletContentConstraint === true
      ? resolveTabletContentMaxWidth(viewportWidth, {
          preferredMaxWidth: tabletContentMaxWidth,
        })
      : undefined
  const $contentConstraintStyle: ViewStyle | undefined =
    resolvedTabletContentMaxWidth == null
      ? undefined
      : {
          width: "100%",
          maxWidth: resolvedTabletContentMaxWidth,
          alignSelf: "center",
        }
