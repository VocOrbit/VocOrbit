...
import type {
  PerfectionAnswerState,
  PerfectionHistoryItem,
  VocabularyPerfectionChallengeViewModel,
} from "./useVocabularyPerfectionChallengeViewModel"
import { spacing } from "@/theme/spacing"

type PerfectionViewProps = VocabularyPerfectionChallengeViewModel & {
  onRequestExit: () => void
  onRequestShare: () => void
}
...
const PerfectionIllustration: FC = () => {
  const { themed } = useAppTheme()

  return (
    <View style={themed($perfectionIllustration)}>
      <View style={[themed($perfectionPill), themed($perfectionPillTop)]} />
      <View style={[themed($perfectionPill), themed($perfectionPillMid)]} />
      <View style={[themed($perfectionPill), themed($perfectionPillBottom)]} />
      <View style={themed($perfectionHeart)}>
        <Icon icon="heart" size={42} color="#F29C8F" />
      </View>
      <View style={themed($perfectionPlus)} />
      <View style={themed($perfectionPlusVertical)} />
    </View>
  )
}

export const VocabularyPerfectionChallengeView: FC<PerfectionViewProps> = ({
  phase,
  summaryView,
  title,
  rules,
      ...
      >
        ...
        <View style={themed($introHeader)}>
          <Pressable
            ...
            accessibilityRole="button"
            accessibilityLabel="Close Perfection"
          ...
          <AppTutorialVideoButton
            screen="vocabulary_perfection_challenge"
            placement="overview"
            variant="help"
        ...
        <View style={themed([$introFooter, $bottomInsets])}>
          <Pressable
            onPress={onStart}
            accessibilityRole="button"
            accessibilityLabel="Start Perfection"
    ...
    return (
      ...
      >
        ...
        >
          ...
          <Text
            style={[themed($summaryTitle), { marginBottom: theme.spacing.lg }]}
            text="Lives are up!"
          />
...
const $perfectionIllustration: ThemedStyle<ViewStyle> = () => ({
  height: 150,
  width: 200,
  alignItems: "center",
  justifyContent: "center",
...
const $perfectionPill: ThemedStyle<ViewStyle> = () => ({
  position: "absolute",
  height: 22,
  width: 96,
  borderRadius: 999,
...
const $perfectionPillTop: ThemedStyle<ViewStyle> = () => ({
  backgroundColor: "#F29C8F",
  transform: [{ rotate: "-12deg" }, { translateY: -16 }],
})

const $perfectionPillMid: ThemedStyle<ViewStyle> = () => ({
  backgroundColor: "#F4F0E8",
  transform: [{ rotate: "-12deg" }, { translateY: 4 }],
})

const $perfectionPillBottom: ThemedStyle<ViewStyle> = () => ({
  backgroundColor: "#F4F0E8",
  transform: [{ rotate: "-12deg" }, { translateY: 24 }],
})

const $perfectionHeart: ThemedStyle<ViewStyle> = () => ({
  position: "absolute",
  top: 12,
})

const $perfectionPlus: ThemedStyle<ViewStyle> = () => ({
  position: "absolute",
  height: 4,
  width: 14,
  borderRadius: 2,
...
const $perfectionPlusVertical: ThemedStyle<ViewStyle> = () => ({
  position: "absolute",
  height: 14,
  width: 4,
  borderRadius: 2,
