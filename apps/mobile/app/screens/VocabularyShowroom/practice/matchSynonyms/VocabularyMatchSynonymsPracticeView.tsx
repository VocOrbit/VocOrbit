...
import type {
  MatchSynonymsAnswer,
  MatchSynonymsAnswerState,
  MatchSynonymsQuestion,
  VocabularyMatchSynonymsPracticeViewModel,
} from "./useVocabularyMatchSynonymsPracticeViewModel"
...
type VocabularyMatchSynonymsPracticeViewProps = VocabularyMatchSynonymsPracticeViewModel & {
  onRequestLeave: () => void
  onRequestLogin: () => void
...
const resolveOptionTone = (
  answer: MatchSynonymsAnswer,
  question: MatchSynonymsQuestion,
  selectedId: string | null,
  answerState: MatchSynonymsAnswerState,
): OptionTone => {
...
export const VocabularyMatchSynonymsPracticeView: FC<VocabularyMatchSynonymsPracticeViewProps> = ({
      ...
      <View style={themed($headerRow)}>
        ...
        <View style={themed($headerSpacer)}>
          <AppTutorialVideoButton
            screen="vocabulary_match_synonyms_practice"
            placement="overview"
            variant="help"
        ...
        {hasQuestions ? (
          <>
            ...
            <Text
              ...
              text={translate("vocabulary:practiceHub.instructions.matchSynonyms")}
            />
...
const $instructionText: ThemedStyle<TextStyle> = ({ spacing, typography, colors }) => ({
