...
import { VocabularyCaptureScreen } from "@/screens/VocabularyShowroom/capture/VocabularyCaptureScreen"
...
const AppStack = () => {
  ...
  if (
    ...
    return <AppBootScreen message="Syncing your library and preferences..." />
  }
      ...
      {isAuthenticated ? (
        forceUpdateRequired ? (
          ...
          <>
            ...
            <Stack.Screen name="VocabularyCapture" component={VocabularyCaptureScreen} />
            ...
            <Stack.Screen name="VocabularyPracticeDetail" component={VocabularyPracticeDetailScreen} />
            <Stack.Screen
            ...
            />
            <Stack.Screen name="VocabularyRushChallenge" component={VocabularyRushChallengeScreen} />
            <Stack.Screen
              name="VocabularyPerfectionChallenge"
              component={VocabularyPerfectionChallengeScreen}
            />
            <Stack.Screen name="VocabularySprintChallenge" component={VocabularySprintChallengeScreen} />
          </>
        )
      ) : (
        <>
...
export const AppNavigator = (props: NavigationProps) => {
  ...
  useEffect(() => {
    ...
    void (async () => {
      ...
      const unsubscribe = await registerRepeatNotificationOpenListener(openVocabularyDetail)
      if (cancelled) {
        unsubscribe()
        return
      }
      cleanup = unsubscribe
      await consumeLastRepeatNotificationOpen(openVocabularyDetail)
    })()
  ...
  }, [isAuthenticated, openVocabularyDetail, userId])
  ...
  }, [externalOnReady, isAuthenticated, openShareCapture, openVocabularyDetail])
